Feature: E.129.300 - The system shall support the ability to make Configuration Monitor external module discoverable by users.
...
Scenario: E.129.300 - Make module discoverable by users
    ...
    # Then I should see "Enable module 'Configuration Monitor - '?" in the iframe
