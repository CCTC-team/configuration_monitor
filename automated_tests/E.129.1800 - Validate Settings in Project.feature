Feature: E.129.1800 - The system shall validate that email settings are complete when email notifications are enabled at either the system or project level.
  ...
  Scenario: Enable external Module from Control Center
    ...
    Then I should see a table header and row containing the following values in the logging table:
      ...
      | mm/dd/yyyy hh:mm | test_admin | Disable external module "configuration_monitor_v1.1.0" for project                  |                                                                                                                            |
      | mm/dd/yyyy hh:mm | test_admin | Modify configuration for external module "configuration_monitor_v1.1.0" for project | max-hours-email                                                                                                            |
      | mm/dd/yyyy hh:mm | test_admin | Modify configuration for external module "configuration_monitor_v1.1.0" for project | max-days-page                                                                                                              |
      | mm/dd/yyyy hh:mm | test_admin | Modify configuration for external module "configuration_monitor_v1.1.0" for project | user-role-changes-enable, email-enable, from-emailid, to-emailids                                                          |
      | mm/dd/yyyy hh:mm | test_admin | Modify configuration for external module "configuration_monitor_v1.1.0" for project | reserved-hide-from-non-admins-in-project-list, user-role-changes-enable, project-changes-enable, email-enable, to-emailids |
      | mm/dd/yyyy hh:mm | test_admin | Enable external module "configuration_monitor_v1.1.0" for project                   |                                                                                                                            |
    ...
    Then I should see a table header and row containing the following values in a table:
      | Time             | User       | Event                                                                               |
      | mm/dd/yyyy hh:mm | test_admin | Disable external module "configuration_monitor_v1.1.0" for system                   |
      | mm/dd/yyyy hh:mm | test_admin | Disable external module "configuration_monitor_v1.1.0" for project                  |
      | mm/dd/yyyy hh:mm | test_admin | Modify configuration for external module "configuration_monitor_v1.1.0" for project |
      | mm/dd/yyyy hh:mm | test_admin | Enable external module "configuration_monitor_v1.1.0" for project                   |
      | mm/dd/yyyy hh:mm | test_admin | Enable external module "configuration_monitor_v1.1.0" for system                    |
