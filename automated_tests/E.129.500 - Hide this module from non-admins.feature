Feature: E.129.500 - The system shall support the ability to hide Configuration Monitor external module from non-admins in the list of enabled modules on each project.
...
Scenario: E.129.500 - Hide this module from non-admins in the list of enabled modules on each project
    ...
    When I create a new project named "E.129.500" by clicking on "New Project" in the menu bar, selecting "Practice / Just for fun" from the dropdown, choosing file "fixtures/cdisc_files/Project_redcap_val_nodata.xml", and clicking the "Create Project" button
