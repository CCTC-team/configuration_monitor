...
Scenario: E.129.600 - Module configuration permissions in projects
    ...
    When I create a new project named "E.129.600" by clicking on "New Project" in the menu bar, selecting "Practice / Just for fun" from the dropdown, choosing file "fixtures/cdisc_files/Project_redcap_val_nodata.xml", and clicking the "Create Project" button
...
Scenario: E.129.700 - View Usage of the external module
    ...
    And I should see a link labeled "E.129.600"
    When I click on the link labeled "E.129.600"
