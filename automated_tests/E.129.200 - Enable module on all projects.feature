Feature: E.129.200 - The system shall support the ability to enable Configuration Monitor external module on all projects by default.
...
Scenario: E.129.200 - Enable module on all projects by default
    ...
    When I create a new project named "E.129.200" by clicking on "New Project" in the menu bar, selecting "Practice / Just for fun" from the dropdown, choosing file "fixtures/cdisc_files/Project_redcap_val_nodata.xml", and clicking the "Create Project" button
