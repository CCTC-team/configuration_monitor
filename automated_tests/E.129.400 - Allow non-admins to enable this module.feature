Feature: E.129.400 - The system shall support the ability to allow non-admins to enable Configuration Monitor external module on projects.
...
Scenario: E.129.400 - Allow non-admins to enable this module on projects
    ...
    When I create a new project named "E.129.400" by clicking on "New Project" in the menu bar, selecting "Practice / Just for fun" from the dropdown, choosing file "fixtures/cdisc_files/Project_redcap_val_nodata.xml", and clicking the "Create Project" button
