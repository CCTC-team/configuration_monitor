...
CREATE TRIGGER redcap_projects_insert_trigger
...
BEGIN
	...
	-- CHECK SIMILAR - unique_role_name is updated later after insert, so not include here as it will be empty string
...
END$$
-- drop trigger redcap_projects_insert_trigger;