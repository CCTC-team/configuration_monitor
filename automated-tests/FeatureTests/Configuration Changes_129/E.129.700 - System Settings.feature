Feature: E.129.700 - The system shall support the ability to set up and view logs using Configuration Monitor module.
  ...
  Scenario: Enable external Module from Control Center
    ...
    When I enter "to@sys.com" into the input field labeled "Provide the email address used to send notifications"
    And I click on the button labeled "Save" in the dialog box
    Then I should see "Provide the email address to receive configuration change notifications"
    When I enter "from@sys.com" into the input field labeled "Provide the email address to receive configuration change notifications"
    And I click on the button labeled "Save" in the dialog box
    Then I should see "Configuration Monitor - v1.0.0"
    ...
    And I click on the button labeled "Save" in the dialog box
    When I enter "4" into the input field labeled "Specify the maximum number of days to look back when displaying system configuration changes on the page (default 7 days)"
    And I click on the button labeled "Save" in the dialog box
    Then I should see "Configuration Monitor - v1.0.0"
    ...
    And I click on the button labeled "Save" in the dialog box
    When I enter "2" into the input field labeled "Specify the maximum number of hours to look back when sending email notifications (default 3 hours)"
    And I click on the button labeled "Save" in the dialog box
    Then I should see "Configuration Monitor - v1.0.0"
    # And I logout
